...
const LOT_STATUSES = [LOT_WITHDRAWN, LOT_SOLD, LOT_PASSED, LOT_BIDDING_OPEN, LOT_BIDDING_CLOSED];

const LOT_TYPES = AUCTION_TYPES;

export { LOT_WITHDRAWN, LOT_SOLD, LOT_PASSED, LOT_BIDDING_OPEN, LOT_BIDDING_CLOSED, LOT_STATUSES, LOT_TYPES };
