...
export async function updateLotStatuses(lotId?: any) {
    console.log("🔄 [updateLotStatuses] Starting lot status update...");
    ...
    for (const lot of lots) {
        ...
        console.log(`✅ [updateLotStatuses] Completed update for lot ${lot.title} → Status: ${newStatus}`);
